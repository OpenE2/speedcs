...
#Region "index.html"
    ...
    Private Sub GenerateIndex(ByVal sMessage As StringBuilder, ByVal sBuffer As StringBuilder)
        ...
        sMessage.Append(ButtonBar())
        sMessage.Append("<table border=1>")
        sMessage.Append("<tr><th>Computer Name</th><td>" & Environment.MachineName & "</td></tr>")
        sMessage.Append("<tr><th>OS Version</th><td>" & Environment.OSVersion.ToString & "</td></tr>")
        sMessage.Append("<tr><th>OS Running time</th><td>" & Environment.TickCount / 1000 & " Sec.</td></tr>")
        sMessage.Append("<tr><th>SpeedCS Start time</th><td>" & SpeedCSStartTime & "</td></tr>")
